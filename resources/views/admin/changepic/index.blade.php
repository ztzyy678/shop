						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center"> {{ $v->changepic_name }}</td>
								<td><img src="/uploads/{{ $v->changepic_img }}" width="120px"></td>
								<td>
									<form style="display: inline-block;" action="/admin/changepic/{{$v->id}}" method="post">
										{{	csrf_field() }}
										{{ method_field('DELETE') }}
