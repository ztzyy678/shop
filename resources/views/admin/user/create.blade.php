		...
		<div class="row-fluid sortable ui-sortable">
				<div class="box span12">
					<div class="box-header" data-original-title="">
						<h2><i class="halflings-icon white edit"></i><span class="break">	</span>添加用户</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" method="post" action="/admin/users" enctype="multipart/form-data">
							...
							<fieldset>
								...
								<div class="controls">
								  <input class="input-xlarge focused" name="uname" id="username" type="text" value="">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="phone" type="number" name="tel" value="">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="faceInput" type="file" name="face" value="" accept='image/*'>
							    	...
							    	<div class="control-group">
								<label class="control-label" for="L_pass">密码</label>
								<div class="controls">
							  ...
							  <div class="form-actions">
								...
								<input type="reset" name="" class="btn btn-info value="重置">
							  </div>
							</fieldset>
						  </form>
