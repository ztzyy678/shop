                ...
                if (data) {
                    ...
                    if(typeof(data.active) != "undefined" && typeof(data.active.giftList) != "undefined"){
                        ...
                        for(var i = 0 ; i < gA.giftList.length; i++){
                            oHtml.push('<li class="giftList"><a target="_blank" href="'+gA.giftList[i].giftUrl.substring(5)+'"><img alt="" src="'+gA.giftList[i].giftPic+'" /></a></li>');
                        }
...
(function(){
    ...
    if($("#yg_category h2.rel a")){
        $("#yg_category h2.rel a").attr("href","//www.yougou.com/sr/searchKey.sc?orderBy=0&brandEnName=adidas_adidasneo_adidasoriginals_asics_basto_bata_belle_bevivo_cat_columbia_converse_crocs_disney_hushpuppies_innet_joypeace_millies_newbalance_nike_onitsukatiger_puma_reebok_senda_staccato_tata_teenmix_thenorthface_timberland_vans");
    }
